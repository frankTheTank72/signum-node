...
public class Props {
    ...
    public static final Prop<Integer> API_WEBSOCKET_HEARTBEAT_INTERVAL = new Prop<>("API.WebSocketHeartbeatInterval",
            30);

    public static final Prop<String> NETWORK_NAME = new Prop<>("node.networkName", Constants.SIGNUM_NETWORK_NAME);
    public static final Prop<String> GENESIS_BLOCK_ID = new Prop<>("node.genesisBlockId",
            Convert.toUnsignedLong(Genesis.GENESIS_BLOCK_ID));
    ...
    public static final Prop<Integer> REWARD_RECIPIENT_ENABLE_BLOCK_HEIGHT = new Prop<>(
            "brs.rewardRecipient.startBlock", -1);
    public static final Prop<Integer> DIGITAL_GOODS_STORE_BLOCK_HEIGHT = new Prop<>("brs.digitalGoodsStore.startBlock",
            -1);
    public static final Prop<Integer> AUTOMATED_TRANSACTION_BLOCK_HEIGHT = new Prop<>(
            "brs.automatedTransactions.startBlock", -1);
    ...
    public static final Prop<Integer> P2P_MAX_UNCONFIRMED_TRANSACTIONS = new Prop<>("P2P.maxUnconfirmedTransactions",
            8192);
    public static final Prop<Integer> P2P_MAX_PERCENTAGE_UNCONFIRMED_TRANSACTIONS_FULL_HASH_REFERENCE = new Prop<>(
            "P2P.maxUnconfirmedTransactionsFullHashReferencePercentage", 5);

    public static final Prop<Integer> P2P_MAX_UNCONFIRMED_TRANSACTIONS_RAW_SIZE_BYTES_TO_SEND = new Prop<>(
    ...
    public static final Prop<String> API_ALLOWED = new Prop<>("API.allowed",
    ...
    public static final Prop<Integer> JETTY_API_GZIP_FILTER_MIN_GZIP_SIZE = new Prop<>(
    ...
    public static final Prop<String> JETTY_API_DOS_FILTER_MAX_REQUEST_PER_SEC = new Prop<>(
            "JETTY.API.DoSFilter.maxRequestsPerSec", "30");
    public static final Prop<String> JETTY_API_DOS_FILTER_THROTTLED_REQUESTS = new Prop<>(
    ...
    public static final Prop<String> JETTY_API_DOS_FILTER_MAX_WAIT_MS = new Prop<>("JETTY.API.DoSFilter.maxWaitMs",
            "50");
    public static final Prop<String> JETTY_API_DOS_FILTER_MAX_REQUEST_MS = new Prop<>(
            "JETTY.API.DoSFilter.maxRequestMs", "30000");
    public static final Prop<String> JETTY_API_DOS_FILTER_THROTTLE_MS = new Prop<>("JETTY.API.DoSFilter.throttleMs",
            "30000");
    public static final Prop<String> JETTY_API_DOS_FILTER_MAX_IDLE_TRACKER_MS = new Prop<>(
            "JETTY.API.DoSFilter.maxIdleTrackerMs", "30000");
    public static final Prop<String> JETTY_API_DOS_FILTER_TRACK_SESSIONS = new Prop<>(
            "JETTY.API.DoSFilter.trackSessions", "false");
    public static final Prop<String> JETTY_API_DOS_FILTER_INSERT_HEADERS = new Prop<>(
            "JETTY.API.DoSFilter.insertHeaders", "true");
    public static final Prop<String> JETTY_API_DOS_FILTER_REMOTE_PORT = new Prop<>("JETTY.API.DoSFilter.remotePort",
            "false");
    public static final Prop<String> JETTY_API_DOS_FILTER_IP_WHITELIST = new Prop<>("JETTY.API.DoSFilter.ipWhitelist",
            "127.0.0.1,localhost");
    public static final Prop<String> JETTY_API_DOS_FILTER_MANAGED_ATTR = new Prop<>("JETTY.API.DoSFilter.managedAttr",
            "true");

    public static final Prop<Boolean> JETTY_P2P_GZIP_FILTER = new Prop<>("JETTY.P2P.GZIPFilter", true);
    public static final Prop<Integer> JETTY_P2P_GZIP_FILTER_MIN_GZIP_SIZE = new Prop<>(
    ...
    public static final Prop<String> JETTY_P2P_DOS_FILTER_MAX_REQUESTS_PER_SEC = new Prop<>(
            "JETTY.P2P.DoSFilter.maxRequestsPerSec", "30");
    public static final Prop<String> JETTY_P2P_DOS_FILTER_THROTTLED_REQUESTS = new Prop<>(
    ...
    public static final Prop<String> JETTY_P2P_DOS_FILTER_MAX_WAIT_MS = new Prop<>("JETTY.P2P.DoSFilter.maxWaitMs",
            "50");
    public static final Prop<String> JETTY_P2P_DOS_FILTER_MAX_REQUEST_MS = new Prop<>(
            "JETTY.P2P.DoSFilter.maxRequestMs", "300000");
    public static final Prop<String> JETTY_P2P_DOS_FILTER_THROTTLE_MS = new Prop<>("JETTY.P2P.DoSFilter.throttleMs",
            "30000");
    public static final Prop<String> JETTY_P2P_DOS_FILTER_MAX_IDLE_TRACKER_MS = new Prop<>(
            "JETTY.P2P.DoSFilter.maxIdleTrackerMs", "30000");
    public static final Prop<String> JETTY_P2P_DOS_FILTER_TRACK_SESSIONS = new Prop<>(
            "JETTY.P2P.DoSFilter.trackSessions", "false");
    public static final Prop<String> JETTY_P2P_DOS_FILTER_INSERT_HEADERS = new Prop<>(
            "JETTY.P2P.DoSFilter.insertHeaders", "true");
    public static final Prop<String> JETTY_P2P_DOS_FILTER_REMOTE_PORT = new Prop<>("JETTY.P2P.DoSFilter.remotePort",
            "false");
    public static final Prop<String> JETTY_P2P_DOS_FILTER_IP_WHITELIST = new Prop<>("JETTY.P2P.DoSFilter.ipWhitelist",
            "127.0.0.1,localhost");
    public static final Prop<String> JETTY_P2P_DOS_FILTER_MANAGED_ATTR = new Prop<>("JETTY.P2P.DoSFilter.managedAttr",
            "true");

    public static final Prop<Boolean> INDIRECT_INCOMING_SERVICE_ENABLE = new Prop<>(
